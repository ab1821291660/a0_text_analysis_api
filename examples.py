...
if __name__ == "__main__":
    kmeans_cluster()#{'cluster_3': [0, 1, 3, 4], 'cluster_1': [2, 5, 6, 7, 8, 9], 'cluster_2': [10, 11, 12, 13, 14], 'cluster_0': [15, 16, 17, 18, 19], 'cluster_4': [20, 21, 22, 23, 24]}
    dbscan_cluster()#{'cluster_0': [0, 1, 2, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14], 'cluster_-1': [7, 8, 15, 16, 17, 18, 19, 21], 'cluster_1': [20, 22, 23, 24]}

    fasttext_classification()
                            # # Read 0M words
                            # # Number of words:  4589
                            # # Number of labels: 3
                            # # Progress: 100.0% words/sec/thread:   91569 lr:  0.000000 avg.loss:  1.102526 ETA:   0h 0m 0s
                            # # ### TRAIN RESULT ###
                            # # Train Samples: 30
                            # # Train Precision: 0.36666666666666664
                            # # Train Recall: 0.36666666666666664
                            # # ### TEST RESULT ###
                            # # Test Samples: 30
                            # # Test Precision: 0.36666666666666664
                            # # Test Recall: 0.36666666666666664
                            # #
                            # # model save to fasttext.model.bin
                            # # LOAD MODEL FROM: fasttext.model.bin
                            # # Warning : `load_model` does not return WordVectorModel or SupervisedModel any more, but a `FastText` object which is very similar.
                            # # {'label': [['__label__娱乐', '__label__体育'], ['__label__娱乐', '__label__体育']], 'probability': [array([0.3333457 , 0.33334437], dtype=float32), array([0.33334628, 0.333344  ], dtype=float32)]}
    sentiment_analysis()#{'positive': 2.07329376355}
    cosion_sismilarity()#0.7745966692414834
    edit_similarity()#1
    simhash_similarity()#0
    #
    triple_extraction()
                        #Downloading: 100%|██████████| 164M/164M [02:24<00:00, 1.14MB/s]##===================================默认下载到win这个位置C:\Users\tianxia\.cache\torch\ltp
                        # 履行反洗钱义务的机构及其工作人员依法提交大额交易和可疑交易报告，受法律保护。
                        ...
                        # ---------------------------------------------
    #
    tfidf_summarization()#他强调，人工智能是引领这一轮科技革命和产业变革的战略性技术，具有
    textrank_summarization()#要主攻关键核心技术，以问题为导向，全面增强人工智能科技创新能力，加快
    ####===================================================================================================================================
    ####===================================================================================================================================
    # spell_correct()#松江=>['宋江', '松江', '宋将']  李奎=>['李逵']
    #
    tfidf_keywords()#[('小明', 2.782022232425), ('妈妈', 1.63882820289), ('吃饭', 1.6110557742), ('回家', 1.54806674618)]
    textrank_keywords()#[('妈妈', 1.0), ('回家', 0.9966849915940917), ('吃饭', 0.9929941828082526)]
    keyphrase_extract()#{'轨道交通大兴机场': 0.2007211715122653, '国际机场投运仪式': 0.15032576601404393, #========词云word cloud save to: ./wordcloud.png
    topic_keywords()#{'topic_0': ['篮板', '拍摄', '麦基', '球队', '木乃伊', '球员', '松本润', '这个', '我们', '勇士'],
                    # 'topic_1': ['the', '婚姻', '本周', '电影', '票房', '爱情', '计划', '蜜月', '阿童木', '故事'],
                    # 'topic_2': ['基金', '山西队', '富国', '外援', '目前', '浙江队', '天丰', '由于', '宝贝', '球队'],
